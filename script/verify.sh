...
# aborted run).
#
# As admin it checks that all 24 fn_* functions are granted to
...
[[ "$n" == "24" ]] \
  && ok "momo_app has EXECUTE on all 24 fn_* functions" \
  || bad "expected 24 fn_* functions granted to momo_app" "got: $n"
