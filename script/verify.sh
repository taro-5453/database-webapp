...
# aborted run).
#
# As admin it checks that all 26 fn_* functions are granted to
...
[[ "$n" == "26" ]] \
  && ok "momo_app has EXECUTE on all 26 fn_* functions" \
  || bad "expected 26 fn_* functions granted to momo_app" "got: $n"
